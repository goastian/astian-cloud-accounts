...
return ['routes' => [
    ...
    ['name' => 'shop_account#set_shop_email_post_delete', 'url' => '/shop/set_shop_email_post_delete', 'verb' => 'POST' ],
    ['name' => 'shop_account#set_shop_delete_preference', 'url' => '/shop/set_shop_delete_preference', 'verb' => 'POST' ],
    [
