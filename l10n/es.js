OC.L10N.register(
	"ecloud-accounts",
	{
		...
		"For your information you have %d order(s) in <a class='text-color-active' href='%s'>your account</a>.": "Para su información tiene %d orden(es) en <a class='text-color-active' href='%s'>su cuenta</a>.",
		...
		"Note : As the features are not released yet, you may encounter some bugs. Please report them in {linkopen}GitLab ↗{linkclose} if they have not already been filed. You can also provide some feedback using the form further down.": "Nota : Como las características no están liberadas todavía, puede encontrar algunos errores. Por favor, informa de ellos en {linkopen}GitLab ↗{linkclose} si no han sido ya archivados. También puede proporcionar algunos comentarios utilizando el formulario más abajo.",
		"Want to take a break from novelties? Just click on the button below. You can become a beta user again anytime!": "Quiere descansar de las novedades? Sólo tienes que hacer clic en el botón de abajo. ¡Puedes volver a ser un usuario beta en cualquier momento!",
		"Do you want to become the beta user?": "Desea convertirse en usuario beta?",
		...
		"To get a preview showing of our new features you need to become part of our beta users. To do so, simply click on the button below. You can opt out of beta features anytime.": "Para obtener una vista previa que muestre nuestras nuevas funciones, debe formar parte de nuestros usuarios beta. Para ello, simplemente haga clic en el botón de abajo. Puedes excluirte de las funciones beta en cualquier momento.",
		...
		"Become beta user": "Convertirse en usuario beta",
		"Are you sure you want to opt out of beta features?": "Estás seguro de que quieres excluir las funciones beta?", 
		"Please agree terms & conditions.": "Acepte los términos y condiciones.",
		"You've successfully opt out from the beta users.": "Has conseguido excluir a los usuarios de la beta.",
		...
		"Beta Program is closed for now.": "El Programa Beta está cerrado por ahora.",
